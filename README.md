...
## Summary
This project explores how cardiovascular treatments have evolved over the decades, particularly in relation to smoking and other risk factors. It uses publicly available datasets and merges them into a clean, harmonized dataset to analyze patterns in intervention types, age, and lifestyle risk factors.  

The project is deeply personal to me: I come from a family with a strong history of smoking and cardiovascular disease. My grandfather underwent a long, invasive bypass surgery that left a scar from his heart to his calf. My father, after a heart attack, had a painless stent installed without open surgery. My uncle had two major surgical interventions — one at his heart and another at his calf. Seeing these differences sparked my curiosity: how has treatment evolved? How do smoking and other risk factors influence what intervention patients receive today? This project is my way of investigating these questions through real-world data.
...
2. **Data Cleaning & Processing**
   - Variables were standardized across datasets to ensure comparability.
   - Missing values were handled appropriately.
   - Datasets were merged into a single **processed dataset** for analysis.
...
## Key Insights
- **Smoking and Age Matter:** Smokers and older patients are more likely to receive invasive treatments, while younger non-smokers are more often managed conservatively.
